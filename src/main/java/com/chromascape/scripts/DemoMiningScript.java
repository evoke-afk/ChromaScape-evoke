...
public class DemoMiningScript extends BaseScript {
   ...
   */
  public DemoMiningScript(boolean isFixed, int duration) {
  ...
  protected void cycle() {
    ...
    clickOre();
    Sleeper.waitRandomMillis(800, 1000);
