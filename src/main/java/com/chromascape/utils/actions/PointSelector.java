 ...
 * points within graphical zones. These methods are designed to reduce code
 * duplication and streamline common actions when automating interactions with
 * graphical objects like colours or images.
 *
 * <p>
 * <b>Features:</b>
 *
 ...
 * ChromaScape automation framework. The class does not perform any input
 * actions (such as clicking), but provides the coordinates needed for such
 * actions.
 *
 * <p>
 * <b>Typical Usage:</b>
...
public class PointSelector {
    ...
    /**
     * Searches for the provided image template within the current game view,
     * then returns a random point within the detected bounding box if the match
     * exceeds the defined threshold.
     *
     * @param templatePath the BufferedImage template to locate and click within
     * the larger image view
    ...
    /**
     * Attempts to find a random point inside the contour of the first object of
     * the specified color.
     *
